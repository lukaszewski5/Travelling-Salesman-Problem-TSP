...
public:
    ...
    cost_matrix_t& set_matrix() {return matrix_; };

    const void print_matrix() const; //drukwanie macierzy
...
public:
    ...
    CostMatrix& set_matrix() {return matrix_;}
...
const void print_vec(std::vector<cost_t> vec);
